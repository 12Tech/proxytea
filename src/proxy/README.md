...
This is a sample template for proxy - Below is a brief explanation of what we have generated for you:
...
```bash
sam logs -n HelloWorldFunction --stack-name proxy --tail
```
...
```bash
aws cloudformation delete-stack --stack-name proxy
```
